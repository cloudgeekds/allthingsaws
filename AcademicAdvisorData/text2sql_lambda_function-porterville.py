...
original_db_file = 'demo_academic.db'
target_db_file = '/tmp/demo_academic.db'
...
(Column Name, 'student_id', 'INTEGER')
(Column Name, 'first_name', 'TEXT')
(Column Name, 'last_name', 'TEXT')
(Column Name, 'term', 'INTEGER')
(Column Name, 'course_code', 'TEXT')
...
Table Name 'student_degree_plan':
(Column Name, 'student_id', 'INTEGER')
(Column Name, 'course_code', 'TEXT')
...
#                 query += f' where student_id={student_id}'
        ...
        conn = sqlite3.connect('/tmp/demo_academic.db')
